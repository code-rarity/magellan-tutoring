					...
					<tr>
						...
						<td class="label">
							<label for="product-<?php echo esc_attr($product_id); ?>">
								<?php echo wp_kses_post( $product->is_visible() ) ? '<a href="' . esc_url( apply_filters( 'woocommerce_grouped_product_list_link', get_permalink(), $product_id ) ) . '">' . get_the_title() . '</a>' : get_the_title(); ?>
							</label>
						</td>
