...
<a class="btn btn--primary type--uppercase" href="#purchase-template">Drop your resumé here</a>';
	...
	$ebor_options->add_setting('image', 'stack_logo_mobile', 'Mobile Logo (screens smaller than 991px)', 'logo_section', '', 11);
	...
	$ebor_options->add_setting('input', 'stack_portfolio_description', 'Portfolio Archive Description', 'portfolio_archive_section', '', 11);
	...
	$ebor_options->add_setting('select', 'stack_btt_button', 'Show back to top button?', 'footer_section', 'yes', 19, $yesNo);
	...
	$ebor_options->add_setting('color', 'color_primary_text', 'Primary Coloured Button Text Colour', 'colors', '#ffffff', 6);
