	...
	function ebor_breadcrumbs() {
		...
		if ( $ancestors ) {
			foreach ( $ancestors as $ancestor ) {
				$breadcrumb .= '<li><a href="' . esc_url( get_permalink( $ancestor ) ) . '">' . wp_specialchars_decode( get_the_title( $ancestor ) ) . '</a></li>';
			}
		}
		
		if( is_blog_page() && is_single() ){
			$breadcrumb .= '<li><a href="' . esc_url( get_permalink( get_option( 'page_for_posts' ) ) ) . '">' . wp_specialchars_decode( get_option('stack_blog_title', 'Our Blog') ) . '</a></li><li class="active">' . wp_specialchars_decode( get_the_title( $post->ID ) ) . '</li>';
		} elseif( is_blog_page() ){
			$breadcrumb .= '<li class="active">' . wp_specialchars_decode( get_option('stack_blog_title','Our Blog') ) . '</li>';
		} elseif( is_post_type_archive('product') || is_archive() ){		
			$breadcrumb .= '<li>' . wp_specialchars_decode( single_cat_title('', false) ) . '</li>';		
		} else {
			$breadcrumb .= '<li class="active">' . wp_specialchars_decode( get_the_title( $post->ID ) ) . '</li>';
		}
		...
		<li <?php comment_class(); ?> id="comment-<?php comment_ID() ?>">
			<div class="comment">
				...
				<div class="comment__body">
					...
					<?php echo wpautop( wp_specialchars_decode( get_comment_text() ) ); ?>
